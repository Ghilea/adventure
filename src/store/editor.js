...
export const build = create((set) => ({
  ...
  setMapObject: ({ type, category, position, rotation, objectId }) =>
    set((state) => ({
      ...state,
      mapSettings: {
        ...state.mapSettings,
  ...
  setMapSettings: ({ id, title, order, objects, groundSize }) =>
    set((state) => ({
      ...state,
      mapSettings: {
        ...state.mapSettings,
