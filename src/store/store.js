...
export const player = create((set) => ({
  ...
  updateAbility: (available, type, points) =>
    set((state) => ({
      ...state,
      ability: {
        ...state.ability,
...
export const enemy = create((set) => ({
  ...
  exp: 0,
  dead: true,
  setEnemy: (hp, maxHp, exp, dps, dead) =>
    set((state) => ({
      ...state,
      hp: hp,
      maxHp: maxHp,
...
export const menu = create((set) => ({
  ...
  activeContent: null,
  activeMenu: null,
  changeOptions: (type, type2, value) =>
    set((state) => ({
      ...state,
      options: {
        ...state.options,
