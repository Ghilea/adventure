  ...
  await knex.schema.hasTable("stats").then(async (exists) => {
    ...
    await knex.schema
      .createTable("stats", (table) => {
        ...
        table.decimal("health", 8, 2).notNullable().default(10.0);
        table.float("maxHealth").notNullable().default(10);
        table.decimal("mana", 8, 2).notNullable().default(10.0);
